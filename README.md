# Welcome, finmatrix, to the 2025 TDI Global Hackathon!
...
1. A **Google Cloud** project :cloud: for your team, [see here](https://console.cloud.google.com/home/dashboard?project=hack-team-finmatrix) which allows you to consume Google Cloud (_within a pre-set budget_).
1. A **Microsoft Azure** resource group :cloud: for your team, [see here](XXX) which allows you to consume Azure.
1. This **[GitHub repository](https://github.com/db-hackathon/finmatrix)** which you can use to store your code.
1. A **Terraform Cloud** :hammer: workspace [see here](https://app.terraform.io/app/db-hackathon-2024/workspaces/hack-team-finmatrix) allowing you to deploy with [Terraform](https://developer.hashicorp.com/terraform/intro) into [GCP](https://cloud.google.com/docs/terraform).
...
When logged in, you should be able to see a _project_ named after your team and a project named `hackathon-seed-2021` which contains a [storage bucket](https://console.cloud.google.com/storage/browser/hackathon_shared_storage;tab=objects?forceOnBucketsSortingFiltering=true&inv=1&invt=Ab2_Ug&project=hackathon-seed-2021) with shared materials for your consideration. You can [navigate to the GCP project directly here](https://console.cloud.google.com/welcome?inv=1&invt=Ab2_Ug&project=hack-team-finmatrix).
...
When you log in, you should be able to see a _workspace_ named after your team. You can [navigate to the workspace directly here](https://app.terraform.io/app/db-hackathon-2025/workspaces/hack-team-finmatrix).
...
## [Google Cloud Platform / GCP](https://console.cloud.google.com/home/dashboard?project=hack-team-finmatrix) :cloud:
...
You have an **infrastructure SA** `infrastructure@hack-team-finmatrix.iam.gserviceaccount.com` with the same IAM permissions as team members.
...
This SA is also used when you _provision infrastructure_ using your [Terraform Cloud workspace](https://app.terraform.io/app/db-hackathon-2025/workspaces/hack-team-finmatrix).

You have a **workload SA** `workload@hack-team-finmatrix.iam.gserviceaccount.com` that you can use to attach to your workloads (e.g. Cloud Run revisions).
...
Cloud Function) you must attach your **Workload SA** `workload@hack-team-finmatrix.iam.gserviceaccount.com` , usually referred to in the GCP documentation as _"attaching a custom SA"_.

Both your [GitHub Actions workflows](./.github/workflows/) and [Terraform Cloud workspace](https://app.terraform.io/app/db-hackathon-2025/workspaces/hack-team-finmatrix) have pre-populated variables containing the Workload
SA email.
...
* Cloud Build
    * [gcloud](https://cloud.google.com/build/docs/securing-builds/configure-user-specified-service-accounts)
        * Ensure you specify
          the [--service-account=workload@hack-team-finmatrix.iam.gserviceaccount.com](https://cloud.google.com/sdk/gcloud/reference/builds/submit#--service-account)
...
* [Vertex AI](https://cloud.google.com/vertex-ai/docs/general/custom-service-account#attach)
    * Vertex AI's Console UI does not always expose the field necessary to specify a user managed SA.  
      ...
      (typically `"serviceAccount": "workload@hack-team-finmatrix.iam.gserviceaccount.com"`, to be added as a peer of the `"name": "..."`
...
2. Configure your default Cloud Shell Google Cloud Project by running `gcloud config set project hack-team-finmatrix`

### [GCP Example Apps](https://github.com/db-hackathon/support/tree/main/google-examples) :globe_with_meridians:

# TBC

## [GitHub](https://github.com/db-hackathon/finmatrix) :bookmark_tabs:
...
## [Terraform Cloud](https://app.terraform.io/app/db-hackathon-2024/workspaces/hack-team-finmatrix)
...
Your [Terraform Cloud workspace](https://app.terraform.io/app/db-hackathon-2025/workspaces/hack-team-finmatrix) is [VCS driven](https://developer.hashicorp.com/terraform/tutorials/cloud-get-started/cloud-vcs-change) by this GitHub repository.
